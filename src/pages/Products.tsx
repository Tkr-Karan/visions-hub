  ...
  const products = [
    {
      ...
      description:
        "High-quality standard gypsum boards perfect for residential and commercial applications.",
      features: [
        "Fire resistant",
        "Sound insulation",
        "Easy installation",
    ...
    // },
    {
      ...
      description:
        "Aesthetic gypsum boards with various textures and finishes.",
      features: [
        "Multiple textures",
        "Paint-ready surface",
        "Design flexibility",
      ...
      <section className="py-20 bg-gradient-to-r from-primary/10 to-primary/5">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            Discover our comprehensive collection of high-quality gypsum
            partition solutions, engineered for various applications and
            environments.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {products.map((product, index) => (
              <Card
                key={index}
                className="hover:shadow-soft transition-shadow duration-300 h-full flex flex-col"
              >
                <CardHeader>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-primary-glow">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Our experts are here to help you select the perfect gypsum partition
